...
export class ClassroomService {
  ...
  async get_classrooms_by_student_id(student_id: number) {
    return this.http.get(this.api_url + '/classroom/student/'+student_id, await this.configService.authHeader(true))
  }
